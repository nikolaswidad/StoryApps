...
import com.nikolaswidad.storyappsnew.data.local.RemoteKeys
...
import com.nikolaswidad.storyappsnew.ui.utils.wrapEspressoIdlingResource
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        wrapEspressoIdlingResource {
            return try {
                val responseData =
                    apiService.getStories(page, state.config.pageSize, authToken).listStory
